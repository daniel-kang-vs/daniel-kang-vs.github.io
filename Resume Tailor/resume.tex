...
\begin{itemize}[leftmargin=*, noitemsep, topsep=0pt]
    ...
    \item Designed and analyzed geo split experiments and multivariate bid tests, applying regression-based lift analysis to validate an increase and improve customer acquisition efficiency by 27\% while maintaining conversion volume.  
